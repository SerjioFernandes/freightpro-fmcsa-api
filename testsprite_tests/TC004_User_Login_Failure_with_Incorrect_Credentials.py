...
async def run_test():
    ...
    try:
        ...
        # -> Enter incorrect email and password and submit the login form
        frame = context.pages[-1]
        ...
        # -> Scroll down the page to check if the error message is displayed further down or hidden from immediate view
        await page.mouse.wheel(0, await page.evaluate('() => window.innerHeight'))
        

        # -> Click on the support chat button to see if any error or help message is provided there after failed login
        frame = context.pages[-1]
        # Click Open Support Chat button to check for any error or help messages related to login failure
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login should be rejected with a clear error message when incorrect email or password is entered, but the success message was not found.')
