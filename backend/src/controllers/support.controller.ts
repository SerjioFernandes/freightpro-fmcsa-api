...
const FAQ_DATABASE: Record<string, string> = {
  ...
  'view deliveries': 'Go to your Dashboard to see all your active and completed deliveries. Use filters to find specific shipments.',
  'manage carriers': 'Go to Load Board to view carrier applications for your loads. You can accept, reject, or send proposals to carriers.',
  'request shipping': 'Go to Shipments page, click "Create Shipment", and provide pickup/delivery details. Our team will connect you with carriers.',
  'track shipments': 'Go to Shipments page to see real-time status of all your freight. You can view location updates and delivery confirmations.',
  ...
  'subscription plans': 'We offer Free, Premium, Ultima, and Custom plans. Visit the Pricing page for details.',
